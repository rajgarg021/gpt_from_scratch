...
class GPTLanguageModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.sa_heads = MultiHeadAttention(num_heads, num_embeddings//num_heads) # num_heads heads of (num_embeddings//num_heads)-dimensional self-attention
    ...
    def forward(self, idx, targets=None):
        ...
        x = self.sa_heads(x) # applying multiple heads of self-attention in parallel (B, T, C)
        x = self.ffwd(x) # (B, T, C)
